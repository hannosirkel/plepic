/**
 * `/legal/privacy` in the default edition — a projection of
 * `content/legal/privacy.ts` through the one renderer every locale's copy of
...
export const generateMetadata = makeMetadata("legalPrivacy", DEFAULT_LOCALE);

export default function LegalPrivacyPage() {
  return <LegalRoute routeId="legalPrivacy" locale={DEFAULT_LOCALE} />;
}
