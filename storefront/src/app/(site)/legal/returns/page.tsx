/**
 * `/legal/returns` in the default edition — a projection of
 * `content/legal/returns.ts` through the one renderer every locale's copy of
...
export const generateMetadata = makeMetadata("legalReturns", DEFAULT_LOCALE);

export default function LegalReturnsPage() {
  return <LegalRoute routeId="legalReturns" locale={DEFAULT_LOCALE} />;
}
