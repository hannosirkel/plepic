/**
 * `/legal/terms` in the default edition — a projection of
 * `content/legal/terms.ts` through the one renderer every locale's copy of
...
export const generateMetadata = makeMetadata("legalTerms", DEFAULT_LOCALE);

export default function LegalTermsPage() {
  return <LegalRoute routeId="legalTerms" locale={DEFAULT_LOCALE} />;
}
