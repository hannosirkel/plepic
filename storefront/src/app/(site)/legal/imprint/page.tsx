/**
 * `/legal/imprint` in the default edition — a projection of
 * `content/legal/imprint.ts` through the one renderer every locale's copy of
...
export const generateMetadata = makeMetadata("legalImprint", DEFAULT_LOCALE);

export default function LegalImprintPage() {
  return <LegalRoute routeId="legalImprint" locale={DEFAULT_LOCALE} />;
}
