  ...
  body: [
    {
      ...
      body: [
        "Kui sa ostad tarbijana, võid lepingust taganeda põhjust nimetamata.",
        ...
        "Seadusjärgne 14 päeva tagasimakse tegemiseks hakkab kulgema päevast, mil sa meile teatad; kui pakk on sinu ainus sõnum, algab tagasimakse tähtaeg siis, kui pakk või sinu postitõend meieni jõuab.",
      ],
    ...
    },
    {
      ...
      body: [
        ...
        "Sa võid mängu lahti pakkida ja seda vaadata — sama teeksid poes. Kui komponendid tulevad tagasi kahjustatuna või mittetäielikuna sellise käsitsemise tõttu, mis läheb kaugemale mänguga tutvumisest, võime tagasimakset väärtuse kaotuse võrra vähendada.",
    ...
    },
    {
      ...
      body: [
        "Sõltumata 14-päevasest õigusest ümber mõelda annab Euroopa Liidu õigus sulle seadusjärgse tagatise, et kaup vastab lepingutingimustele: sul on õigus esitada pretensioon kahe aasta jooksul alates kauba kättetoimetamisest iga puuduse kohta, mis oli olemas kauba üleandmisel, ja esimese aasta jooksul eeldatakse, et puudus oli olemas juba üleandmisel, kui me ei tõenda vastupidist. Kui midagi on valesti, teata meile kahe kuu jooksul pärast puuduse märkamist ja me parandame kauba, asendame selle, alandame hinda või tagastame raha, sinu jaoks tasuta.",
      ],
    },
  ],
};
